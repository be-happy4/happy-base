...
insert into sys_config overriding system value values(1, '主框架页-默认皮肤样式名称',     'sys.index.skinName',            'skin-blue',     'Y', 'admin', now(), '', null, '蓝色 skin-blue、绿色 skin-green、紫色 skin-purple、红色 skin-red、黄色 skin-yellow' );
insert into sys_config overriding system value values(2, '用户管理-账号初始密码',         'sys.user.initPassword',         '123456',        'Y', 'admin', now(), '', null, '初始化密码 123456' );
insert into sys_config overriding system value values(3, '主框架页-侧边栏主题',           'sys.index.sideTheme',           'theme-dark',    'Y', 'admin', now(), '', null, '深色主题theme-dark，浅色主题theme-light' );
...
insert into sys_job overriding system value values(1, '系统默认（无参）', 'DEFAULT', 'happyTask.ryNoParams',        '0/10 * * * * ?', '3', '1', '1', 'admin', now(), '', null, '');
insert into sys_job overriding system value values(2, '系统默认（有参）', 'DEFAULT', 'happyTask.ryParams(''happy'')',  '0/15 * * * * ?', '3', '1', '1', 'admin', now(), '', null, '');
insert into sys_job overriding system value values(3, '系统默认（多参）', 'DEFAULT', 'happyTask.ryMultipleParams(''happy'', true, 2000L, 316.50D, 100)',  '0/20 * * * * ?', '3', '1', '1', 'admin', now(), '', null, '');
...
-- 初始化-公告信息表数据
-- ----------------------------
insert into sys_notice overriding system value values('1', '温馨提醒：2018-07-01 开心新版本发布啦', '2', '新版本内容', '0', 'admin', now(), '', null, '管理员');
insert into sys_notice overriding system value values('2', '维护通知：2018-07-01 开心系统凌晨维护', '1', '维护内容',   '0', 'admin', now(), '', null, '管理员');
