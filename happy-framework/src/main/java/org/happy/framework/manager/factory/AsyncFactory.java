package org.happy.framework.manager.factory;
...
import org.happy.common.utils.ip.AddressUtils;
import org.happy.common.utils.ip.IpUtils;
import org.happy.common.utils.spring.SpringUtils;
import org.happy.system.domain.SysLogininfor;
import org.happy.system.domain.SysOperLog;
import org.happy.system.service.ISysLogininforService;
import org.happy.system.service.ISysOperLogService;
        ...
        return new TimerTask() {
            ...
            public void run() {
                ...
                if (StringUtils.equalsAny(status, Constants.LOGIN_SUCCESS, Constants.LOGOUT, Constants.REGISTER)) {
                    logininfor.setStatus(BinaryStatus.SUCCESS);
                } else if (Constants.LOGIN_FAIL.equals(status)) {
                    logininfor.setStatus(BinaryStatus.FAIL);
                }
                // 插入数据
