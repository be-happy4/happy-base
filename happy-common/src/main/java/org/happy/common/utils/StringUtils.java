...
public class StringUtils {
    ...
    public static boolean containsAny(final String cs, final String... searchStrs) {
        if (cs == null || searchStrs == null)
            return false;
    ...
    public static String camelCase2UnderScoreCase(String str) {
        return camelCase2Separated(str, "_");
    }

    public static String camelCase2KebabCase(String str) {
        return camelCase2Separated(str, "-");
    }

    static String camelCase2Separated(String str, String separator) {
        if (str == null) {
            return null;
        }
