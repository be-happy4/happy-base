...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '开心科技',   0, '开心', '15888888888', 'happy@qq.com', '0', '0', 'admin', now(), '', null);
insert into sys_dept values(101,  100, '0,100',      '深圳总公司', 1, '开心', '15888888888', 'happy@qq.com', '0', '0', 'admin', now(), '', null);
insert into sys_dept values(102,  100, '0,100',      '长沙分公司', 2, '开心', '15888888888', 'happy@qq.com', '0', '0', 'admin', now(), '', null);
insert into sys_dept values(103,  101, '0,100,101',  '研发部门',   1, '开心', '15888888888', 'happy@qq.com', '0', '0', 'admin', now(), '', null);
insert into sys_dept values(104,  101, '0,100,101',  '市场部门',   2, '开心', '15888888888', 'happy@qq.com', '0', '0', 'admin', now(), '', null);
insert into sys_dept values(105,  101, '0,100,101',  '测试部门',   3, '开心', '15888888888', 'happy@qq.com', '0', '0', 'admin', now(), '', null);
insert into sys_dept values(106,  101, '0,100,101',  '财务部门',   4, '开心', '15888888888', 'happy@qq.com', '0', '0', 'admin', now(), '', null);
insert into sys_dept values(107,  101, '0,100,101',  '运维部门',   5, '开心', '15888888888', 'happy@qq.com', '0', '0', 'admin', now(), '', null);
insert into sys_dept values(108,  102, '0,100,102',  '市场部门',   1, '开心', '15888888888', 'happy@qq.com', '0', '0', 'admin', now(), '', null);
insert into sys_dept values(109,  102, '0,100,102',  '财务部门',   2, '开心', '15888888888', 'happy@qq.com', '0', '0', 'admin', now(), '', null);
...
-- 初始化-用户信息表数据
-- ----------------------------
<<<<<<<< HEAD:sql/happy_20250417.sql
insert into sys_user values(1,  103, 'admin', '开心', '00', 'happy@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', now(), 'admin', now(), '', null, '管理员');
insert into sys_user values(2,  105, 'happy',    '开心', '00', 'happy@qq.com',  '15666666666', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', now(), 'admin', now(), '', null, '测试员');
========
...
>>>>>>>> origin-ruoyi/springboot3:sql/ry_20250522.sql
...
insert into sys_menu values('4', '开心官网', '0', '4', 'http://happy.vip', null, '', '', 0, 0, 'M', '0', '0', '', 'guide',    'admin', now(), '', null, '开心官网地址');
-- 二级菜单
...
insert into sys_job values(1, '系统默认（无参）', 'DEFAULT', 'happyTask.ryNoParams',        '0/10 * * * * ?', '3', '1', '1', 'admin', now(), '', null, '');
insert into sys_job values(2, '系统默认（有参）', 'DEFAULT', 'happyTask.ryParams(\'happy\')',  '0/15 * * * * ?', '3', '1', '1', 'admin', now(), '', null, '');
insert into sys_job values(3, '系统默认（多参）', 'DEFAULT', 'happyTask.ryMultipleParams(\'happy\', true, 2000L, 316.50D, 100)',  '0/20 * * * * ?', '3', '1', '1', 'admin', now(), '', null, '');
...
-- 初始化-公告信息表数据
-- ----------------------------
insert into sys_notice values('1', '温馨提醒：2018-07-01 开心新版本发布啦', '2', '新版本内容', '0', 'admin', now(), '', null, '管理员');
insert into sys_notice values('2', '维护通知：2018-07-01 开心系统凌晨维护', '1', '维护内容',   '0', 'admin', now(), '', null, '管理员');
